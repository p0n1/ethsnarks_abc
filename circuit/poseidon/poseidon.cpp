...
using ethsnarks::Poseidon_gadget_T;
...
static bool test_constants( ) {
    cout << "test_constants> start" << std::endl;
    ProtoboardT pb;
    ...
    cout << "test_constants> end" << std::endl; 
    return true;
}


static bool test_prove_verify() {
    cout << "test_prove_verify> start" << std::endl;
    ProtoboardT pb;
    ...
    */
    ...
    cout << "test_prove_verify> end" << std::endl;
    return stub_test_proof_verify( pb );
}

static bool test_prove_verify_2() {
    cout << "test_prove_verify_2> start" << std::endl;
    ProtoboardT pb;

    auto var_inputs = make_var_array(pb, "input", {1, 2});

    Poseidon_gadget_T<5, 1, 6, 52, 2, 1> the_gadget(pb, var_inputs, "gadget");    
    the_gadget.generate_r1cs_witness();
    the_gadget.generate_r1cs_constraints();
    if( ! pb.is_satisfied() ) {
        return false;
    ...
    */
    ...
    cout << pb.num_constraints() << " constraints\n"; // 247 constraints
    cout << "test_prove_verify_2> end" << std::endl;
    return stub_test_proof_verify( pb );
}
